...
7. go to project settings in firebase and copy the code in there except for the www.static.. line. ignore that. Copy that into your fbconfig. it should look like this (i removed API key):
